      ...
      <form className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
        ...
        md:p-10 '>
            ...
            <div className='w-full mt-4'>
                ...
                <input id='contact' type="phone" placeholder='Type here' className='border
                border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light ' required/>
            </div>
            ...
            <div className='w-full mt-4'>
                ...
                <input type="text" id='text' placeholder='Type here' className='border
                border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light ' required/>
            </div>
        ...
        text-white mr-auto px-4 py-2 rounded cursor-pointer mt-6 '>
            Register
        </button>
        </div>
