...
const CheckBox = ({label, selected = false, onChange = () => { } }) =>{
  return (
    <label className="flex gap-3 items-center cursor-pointer mt-2 text-sm ">
      ...
      <span className="font-light selected-non" >{label}</span>
    </label>
  )
}
...
const AllRooms = () => {
  ...
  return (
    ...
    items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24
    xl:px-32"
    >
      {/* left section */}
      <div>
        ...
        {roomsDummyData.map((room) => (
          <div
            key={room._id}
            className="flex flex-col md:flex-row items-start py-10
