  ...
  return (
    room && (
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        justify-between bg-white p-6 rounded-xl mx-auto mt-16 max-w-6xl"
        >
        ...
        <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
          <p>Guest wiil be allocated on the ground floor according to availability 
            You get a comfortable Two bedroom apartment has a true city feeling. The 
            price qouted is for two guest, at the guest slot please mark the number of 
