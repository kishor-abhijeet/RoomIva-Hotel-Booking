...
const Dashboard = () => {
    const [first, setfirst] = useState(dashboardDummyData);
  return (
    <div className='absolute top-16 left-[250px] right-0 px-6 pt-4'>
      <Title align='left' font='outfit' className="" title='Dashboard' subTitle='Monitor your room listings
      , track bookings and analze revenue-all in one place. Stay
