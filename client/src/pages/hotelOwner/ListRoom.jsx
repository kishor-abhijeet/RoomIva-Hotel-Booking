...
const ListRoom = () => {
  ...
  return (
    <div className="absolute top-16 left-[250px] right-0 px-6 pt-4">
      <Title
        align="left"
        font="outfit"
        title="Room Listings"
        subTitle="View, edit, or manage all listed rooms. Keep the information up-to-date to provide the best experiance for users."
      />
          ...
          <tbody className="text-sm">
            {
              rooms.map((item, index)=>(
                <tr key={index}>
                  ...
                  <td className="py-3 px-4  border-t border-gray-300 text-red-500 text-center max-sm:hidden">
